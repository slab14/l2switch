...
public class DemoRoutes {
    ...
    public DemoSnort(ing counter, String dataplaneIP, String dockerPort, String ovsPort, String containerImage, String hostPath, String contPath){
    ...
    public DemoSquid(int counter, String dataplaneIP, String dockerPort, String ovsPort, String containerImage, String hostPath, String contPath) {
